...
class RoleplayConfig:
    ...
    debug: bool = False
    use_real_llm: bool = False          # Set True to use real Grok LLM
    grok_model: str = "grok-2-1212"     # or "grok-beta", "grok-3" etc.
...
class RoleplayEngine:
    ...
    def _call_grok_api(self, prompt: str, system_prompt: str = None) -> str:
        """Call xAI Grok API (OpenAI-compatible). Requires XAI_API_KEY env var."""
        import os
        import requests
