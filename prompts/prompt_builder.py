"""
RGFLAT Prompts Package - Prompt Builder & Local Prompt Poet

Memory-aware prompt construction for roleplay.
Moved from flat prompt_poet_local.py into prompts/ package.
"""

from jinja2 import Template
from typing import Dict, Any, Optional

# Note: MemorySystem import will be updated when we finalize cross-package imports
try:
