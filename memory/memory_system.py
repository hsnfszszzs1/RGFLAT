"""
RGFLAT Memory Package - MemorySystem v1.2

Advanced Memory & Lorebook System with Emotional Tagging, Relationship Graph,
Clustering & Enhanced Retrieval.

Moved from flat structure into memory/ package.
"""
